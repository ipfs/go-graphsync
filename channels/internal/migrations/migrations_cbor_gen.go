...
var lengthBufChannelState0 = []byte{142}
...
func (t *ChannelState0) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufChannelState0); err != nil {
		return err
	}
	...
	// t.Vouchers ([]migrations.EncodedVoucher0) (slice)
	...
	// t.VoucherResults ([]migrations.EncodedVoucherResult0) (slice)
...
func (t *ChannelState0) UnmarshalCBOR(r io.Reader) error {
	*t = ChannelState0{}
	...
	if extra > 0 {
		t.Vouchers = make([]EncodedVoucher0, extra)
	}

	for i := 0; i < int(extra); i++ {

		var v EncodedVoucher0
	...
	if extra > 0 {
		t.VoucherResults = make([]EncodedVoucherResult0, extra)
	}

	for i := 0; i < int(extra); i++ {

		var v EncodedVoucherResult0
		if err := v.UnmarshalCBOR(br); err != nil {
			return err
		}
...
var lengthBufEncodedVoucher0 = []byte{130}
...
func (t *EncodedVoucher0) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufEncodedVoucher0); err != nil {
		return err
	}
...
var lengthBufEncodedVoucherResult0 = []byte{130}
...
func (t *EncodedVoucherResult0) MarshalCBOR(w io.Writer) error {
	...
	if _, err := w.Write(lengthBufEncodedVoucherResult0); err != nil {
		return err
	}
