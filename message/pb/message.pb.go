...
type Message_Request struct {
	...
	Id         []byte            `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                                                                                         // unique id set on the requester side
...
func (x *Message_Request) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
type Message_Response struct {
	...
	Id         []byte            `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`                                                                                                         // the request id
...
func (x *Message_Response) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
